...
*   **Solution:**
    ...
    *   Corrected `MONGO_URI` in `apps/api/.env` to `mongodb://uttam:REDACTED_MONGO_PASSWORD@localhost:27017/family-website?authSource=admin` for API running on host and connecting to Dockerized MongoDB.
