...
import { performanceMonitor, memoryMonitor, cpuMonitor } from './middleware/performance.js';
  ...
  try {
    ...
    const server = app.listen(env.PORT, () => {
      ...
      if (env.NODE_ENV === 'development') {
        ...
        logger.info(`🔗 API Health Check: http://localhost:${env.PORT}/api/health-check`);
      }
    });
