...
export const en = {
    ...
    "register.error.accountExists": "An account with that email or username already exists. Try signing in instead.",
    "register.error.rateLimited": "Too many sign-ups — please wait a few minutes and try again.",
    "register.error.generic": "Something went wrong. Please try again.",
    "register.success.title": "Check your email",
    "register.success.description": "One last step before you're in.",
    "register.success.message": "We sent a verification link to {email}. Click it to verify your email, then sign in once an administrator has approved your account.",
    "register.success.resend": "Didn't get it? Resend the link",
    "register.success.backToSignIn": "Back to sign in",
    ...
    "forgot.error": "Couldn't send the reset link. Please try again or contact support.",
    "forgot.success.title": "Check your email",
    "forgot.success.description": "If an account exists, a reset link is on its way.",
    "forgot.success.message": "We've sent a password reset link to {email}. It expires in 30 minutes.",
    "forgot.success.backToSignIn": "Back to sign in",

    // Reset Password
    "reset.title": "Set a new password",
    "reset.description": "Choose a strong password for your account.",
    ...
    "reset.error.generic": "Couldn't reset your password. The link may be invalid or expired.",
    "reset.invalid.title": "Invalid link",
    "reset.invalid.description": "This reset link is invalid or has expired.",
    "reset.invalid.action": "Request a new link",
    "reset.success.title": "Password updated",
    "reset.success.description": "You can sign in with your new password.",
    "reset.success.action": "Go to sign in",

    // Verify Email
    "verify.title": "Verifying your email",
    "verify.description.pending": "We're verifying your email address...",
    "verify.description.success": "You're all set.",
    "verify.description.error": "Hold on a moment…",
    "verify.pending": "Confirming your verification link…",
    "verify.success.message": "Your email is verified. Your account will be active once an administrator approves it.",
    "verify.success.action": "Go to sign in",
    "verify.error.message": "This verification link is invalid or has expired.",
    "verify.error.action": "Resend verification link",

    // Resend Verification
    "resend.title": "Resend verification email",
    "resend.description": "Enter the email you signed up with and we'll send a new link.",
    "resend.email": "Email",
    "resend.submit": "Send verification link",
    "resend.submitting": "Sending...",
    "resend.error": "Failed to send verification email. Please try again.",
    "resend.success.title": "Check your email",
    "resend.success.description": "A fresh verification link is on its way.",
    "resend.success.backToSignIn": "Back to sign in",
    "resend.backToSignIn": "Back to sign in",
