...
export const en = {
    ...
    "search.noResultsSuggest": "Try searching for",
    "search.suggest.members": "member names",
    "search.suggest.photos": "photo captions",
    "search.suggest.events": "event titles",
    "search.suggest.chat": "chat messages",
...
export const translations = { en } as const satisfies Record<string, Record<string, string>>;
