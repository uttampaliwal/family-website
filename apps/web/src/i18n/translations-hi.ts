...
export const hi: Record<keyof typeof en, string> = {
  ...
  "legal.contact.mailtoNote":
    "यह संदेश पहले से भरकर आपका ईमेल ऐप खोलता है — कुछ भी हमारे सर्वर पर संग्रहीत या भेजा नहीं जाता।",
  ...
  "register.error.accountExists":
    "इस ईमेल या यूज़रनेम से पहले से अकाउंट है। साइन इन करने की कोशिश करें।",
  "register.error.rateLimited":
    "बहुत अधिक साइन-अप — कृपया कुछ मिनट प्रतीक्षा करें और फिर कोशिश करें।",
  ...
  "register.success.message":
    "हमने {email} पर एक सत्यापन लिंक भेजा है। इसे क्लिक करके अपना ईमेल सत्यापित करें, फिर किसी प्रशासक द्वारा अनुमोदित होने पर साइन इन करें।",
  ...
  "forgot.error":
    "रीसेट लिंक नहीं भेज सके। कृपया फिर से कोशिश करें या सहायता से संपर्क करें।",
  "forgot.success.title": "ईमेल देखें",
  "forgot.success.description":
    "यदि कोई अकाउंट है, तो रीसेट लिंक भेज दिया गया है।",
  "forgot.success.message":
    "हमने {email} पर एक पासवर्ड रीसेट लिंक भेजा है। यह 30 मिनट में समाप्त हो जाता है।",
  ...
  "reset.error.generic":
    "पासवर्ड रीसेट नहीं कर सके। लिंक अमान्य या समाप्त हो सकता है।",
  ...
  "verify.success.message":
    "आपका ईमेल सत्यापित है। किसी प्रशासक द्वारा अनुमोदित होने के बाद आपका अकाउंट सक्रिय हो जाएगा।",
