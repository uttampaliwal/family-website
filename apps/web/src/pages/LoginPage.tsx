    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="font-cursive text-4xl md:text-5xl font-bold mb-2" style={{ backgroundImage: 'linear-gradient(45deg, oklch(var(--color-primary)), oklch(var(--color-accent)))', WebkitBackgroundClip: 'text', backgroundClip: 'text', color: 'transparent' }}>Welcome Back</h1>
