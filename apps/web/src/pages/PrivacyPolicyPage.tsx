            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-base leading-relaxed mb-4">
                  Welcome to our Family Portal ("we," "our," or "the website").
                  This Privacy Policy explains how we collect, use, disclose,
                  and safeguard your information when you visit our family
                  website and use our services. This website is designed as a
                  private family portal for sharing memories, documents, and
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-6 ml-11">
                  ...
                  <li>
                    <strong>Profile Information:</strong> Date of birth, gender,
                    mobile number (optional)
                  </li>
                  <li>
                    <strong>Family Content:</strong> Photos, documents, stories,
                    and other content you choose to share
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  ...
                  <li>
                    <strong>Family Communication:</strong> Enable sharing of
                    photos, documents, and messages within the family
                  </li>
                  <li>
                    <strong>Security:</strong> Protect against unauthorized
                    access and maintain platform security
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Technical Support:</strong> Provide customer support
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  <li>
                    <strong>Within Family:</strong> Content you share is visible
                    to other authenticated family members
                  </li>
                  <li>
                    <strong>Service Providers:</strong> Trusted third-party
                    services that help us operate the website (hosting, email
                    services)
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    merger, acquisition, or sale of assets (with notice)
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  ...
                  <li>
                    <strong>Password Security:</strong> Passwords are hashed and
                    salted using industry-standard algorithms
                  </li>
                  <li>
                ...
                <div className="bg-warning/10 border border-warning/20 rounded-lg p-4 ml-11 mt-4">
                  <p className="text-base">
                    <strong>Important:</strong> While we implement robust
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  ...
                  <li>
                    ...
                    settings, language preferences, and layout choices
                  </li>
                  <li>
                    <strong>Analytics Cookies:</strong> Help us understand how
                    you use the website to improve performance
                  </li>
                  <li>
                    <strong>Session Storage:</strong> Temporary storage for your
                    current session and form data
                  </li>
                </ul>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  <li>
                    ...
                    is active and for 1 year after deactivation
                  </li>
                  <li>
                    <strong>Family Content:</strong> Preserved as long as family
                    members wish to maintain shared memories
                  </li>
                  <li>
                    <strong>Log Data:</strong> Automatically deleted after 90
                    days unless required for security investigations
                  </li>
                  <li>
                    <strong>Communication Records:</strong> Retained for 2 years
                    for family reference and dispute resolution
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-base leading-relaxed mb-4 ml-11">
                  Our family portal may include content related to children
                  within our family. We are committed to protecting children's
                  privacy:
                </p>
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  <li>
                    <strong>Email Services:</strong> For account verification
                    and password reset emails
                  </li>
                  <li>
                    <strong>Cloud Storage:</strong> Secure storage of family
                  ...
                  <li>
                    <strong>CDN Services:</strong> Content delivery networks for
                    faster loading times
                  </li>
                </ul>
                <p className="text-base leading-relaxed ml-11">
                  These services have their own privacy policies. We encourage
                  you to review them when using integrated features.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  ...
                  <li>
                    We comply with applicable data protection regulations (GDPR,
                    CCPA, etc.)
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-base space-y-2 mb-4 ml-11">
                  <li>
                    We will post the updated policy on this page with a new
                    "Last updated" date
                  </li>
                  <li>
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-6 ml-11">
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <div>
                        <strong>Email:</strong> uttam232002@gmail.com
                      </div>
                    </div>
                    <div className="flex items-center">
                      <span className="w-6 h-6 bg-primary rounded-full flex items-center justify-center mr-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        <strong>Subject Line:</strong> Please include "Privacy
                        Policy" in your email subject
                      </div>
                    </div>
                  </div>
                </div>
