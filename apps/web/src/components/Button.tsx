...
const Button: React.FC<ButtonProps> = ({ label, className, isPrimary = false, ...props }) => {
  const baseClasses = "rounded-xl border px-4 py-2 text-base font-medium font-sans cursor-pointer transition-all duration-200 ease-in-out transform hover:-translate-y-1";
