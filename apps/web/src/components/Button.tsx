...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    primary:
      "bg-gradient-primary text-white shadow-md hover:scale-105 transform transition-transform duration-200 focus:ring-primary",
    secondary:
      "bg-secondary text-text-base shadow-md hover:bg-secondary/90 focus:ring-secondary",
    success:
      "bg-success text-white shadow-md hover:bg-success/90 focus:ring-success",
    warning:
      "bg-warning text-text-base shadow-md hover:bg-warning/90 focus:ring-warning",
