  ...
  return (
    <div className="md:hidden">
      <button 
        ...
        className="p-2 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 focus:outline-none"
        aria-label="Menu"
      >
            ...
            <div className="py-2">
              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <Link 
                    to="/register" 
                    className="block px-4 py-2 text-primary-600 dark:text-primary-400 font-medium hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                    onClick={() => setIsOpen(false)}
                  >
                    Register
                  </Link>
